...
@section('titulo_pagina','Editar Proceso')
@section('contenido')
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Editar Proceso</strong>                           
                        </div>
                        <div class="card-body">
                            <form action="{{route('actualizar_proceso')}}" method="post" accept-charset="UTF-8">
                                {{csrf_field()}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3">
                                      ...
                                      <div class="input-group">
                                        <input id="presupuesto" name="presupuesto" type="number" step="0.01" class="form-control" required  value="{{$proceso->presupuesto}}">
                                      </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                      <label for="descripcion" class="control-label mb-1">Descripcion</label>
                                      <div class="input-group">
                                        <textarea id="descripcion" name="descripcion" type="text" class="form-control" required  style="resize: none">{{$proceso->descripcion}}</textarea>
                                      </div>
                                    </div>    
                                </div>
                                <button class="btn btn-primary form-control"><i class="fa fa-save"></i> Actualizar</button>
